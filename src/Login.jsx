...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-[#05070a] flex flex-col items-center justify-center p-4 selection:bg-indigo-500/30 relative overflow-hidden">
      ...
      <div className="bg-white/5 backdrop-blur-3xl border border-white/10 p-10 md:p-14 rounded-[4rem] w-full max-w-md shadow-[0_0_80px_rgba(0,0,0,0.5)] relative z-10">
        <div className="flex flex-col items-center mb-10 text-center">
          ...
          <h1 className="text-3xl font-black text-white tracking-tight leading-none mb-1">ccdeck</h1>
          <p className="text-[9px] font-bold text-indigo-400 tracking-[0.4em] uppercase">Secure Access</p>
        </div>
        ...
        <form onSubmit={handleEmailAuth} className="space-y-4 mb-8">
          <div>
            <input
              ...
              required
              className="w-full bg-white/[0.03] border border-white/5 rounded-2xl px-5 py-4 text-white font-black outline-none text-sm placeholder:text-gray-500 focus:border-indigo-500/50 transition-colors"
            />
          </div>
          <div>
            <input
        ...
        <button
          ...
          disabled={isLoading}
          className="w-full bg-white text-black hover:bg-gray-100 disabled:opacity-50 px-7 py-4 rounded-2xl font-black transition-all flex items-center justify-center gap-3 shadow-lg text-xs uppercase tracking-widest"
        >
